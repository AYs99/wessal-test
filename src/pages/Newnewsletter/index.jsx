        ...
        <div className="flex md:flex-col flex-row md:gap-5 items-start justify-evenly w-full">
          ...
          <div className="flex flex-1 flex-col gap-11 items-center justify-start md:px-5 w-full">
            ...
            <div className="flex flex-col items-start justify-start w-[88%] md:w-full">
              ...
              >
                <span className="text-light_blue-300 font-dinnextltarabic text-left font-bold">
                  Send New{" "}
                </span>
                <span className="text-light_blue-300 font-dinnextltarabic text-left font-normal">
                  Message
                </span>
              </Text>
              ...
              <div className="flex flex-col gap-2 items-start justify-start mt-[22px] w-full">
                <Text
                  className="text-base text-white-A700"
                  size="txtDINNextLTArabicBold16WhiteA700"
                >
                ...
                <TextArea
                  className="bg-transparent border border-solid border-white-A700 leading-[normal] pb-[35px] pl-6 pr-[35px] pt-4 sm:px-5 rounded-lg text-base text-left placeholder:text-white-A700 text-white-A700 w-full"
                  name="groupFortySeven"
                  placeholder="Body"
                ></TextArea>
              </div>
              <Button
                className="cursor-pointer font-medium min-w-[1036px] md:min-w-full mt-5 text-[17.59px] text-center"
                shape="round"
