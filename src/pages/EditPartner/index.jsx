          ...
          <div className="flex flex-1 flex-col font-cairo gap-[42px] items-center justify-start md:px-5 w-full">
            ...
            <div className="flex flex-col font-dinnextltarabic gap-[21px] items-start justify-start w-[88%] md:w-full">
              ...
              <div className="flex flex-col gap-[9px] items-start justify-start w-full">
                ...
                <Input
                  name="group109"
                  placeholder="Smart One"
                  className="leading-[normal] p-0 placeholder:text-white-A700 text-base text-left w-full"
                  wrapClassName="rounded-md w-full"
                  shape="round"
                ></Input>
              </div>
              <div className="flex flex-col items-center justify-end outline-[0.5px] outline-dashed outline-white-A700 p-[35px] sm:px-5 rounded-lg w-full">
                <div className="flex flex-col gap-1.5 items-center justify-start mt-[5px] w-[13%] md:w-full">
                  <Img
                    className="h-12 w-12"
