    ...
    },
    {
      icon: (
        <Img
          ...
          src="images/img_imageicondashboard_blue_gray_800.svg"
          alt="imageicondashbo"
        />
      ),
      label: "services",
          ...
          <div className="flex flex-1 flex-col font-cairo gap-[42px] items-center justify-start md:px-5 w-full">
            ...
            <div className="flex flex-col font-dinnextltarabic items-start justify-start w-[88%] md:w-full">
              ...
              <div className="flex md:flex-col flex-row font-cairo md:gap-5 items-start justify-start mt-[17px] w-[99%] md:w-full">
                ...
                <Text
                  className="capitalize md:ml-[0] ml-[161px] text-base text-white-A700"
                  size="txtCairoBold16"
                >
                  Icon
                </Text>
              ...
              <Button
                className="cursor-pointer font-medium min-w-[1036px] md:min-w-full mt-[54px] text-[17.59px] text-center"
                shape="round"
                color="light_blue_300"
                size="sm"
                variant="fill"
