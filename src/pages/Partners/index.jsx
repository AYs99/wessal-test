    ...
    <>
      <div className="bg-blue_gray-800 flex flex-col font-dinnextltarabic items-center justify-start mx-auto w-full">
        <div className="flex md:flex-col flex-row md:gap-5 items-start justify-evenly w-full">
          <Sidebar3 className="!sticky !w-[254px] bg-blue_gray-800 flex h-screen md:hidden justify-start overflow-auto md:px-5 shadow-bs1 top-[0]" />
          <div className="flex flex-1 flex-col font-cairo gap-[42px] items-center justify-start md:px-5 w-full">
            ...
            <div className="flex flex-col font-dinnextltarabic items-start justify-start w-[88%] md:w-full">
              ...
              <div className="flex flex-row font-cairo md:gap-10 items-start justify-between mt-[17px] w-[99%] md:w-full">
                <Text
              ...
              <List
                className="flex flex-col font-dinnextltarabic gap-[11px] items-center mt-[13px] w-[99%]"
              ...
              >
                <div className="flex md:flex-col flex-row md:gap-5 items-center justify-start w-full">
                  ...
                  <Img
                    className="h-[50px] md:ml-[0] ml-[298px] w-[50px]"
                    src="images/img_favorite_white_a700_50x50.svg"
                    alt="favorite"
                  />
                  <Img
                    className="h-8 md:ml-[0] ml-[273px] w-8"
                    src="images/img_toggleon.svg"
                    alt="toggleon"
                  />
                  <Img
                    className="common-pointer h-[18px] md:ml-[0] ml-[250px] w-[18px]"
                    src="images/img_edit.svg"
                    alt="edit"
                    onClick={() => navigate("/editteammember")}
                  />
                  <Img
                    className="h-[18px] ml-5 md:ml-[0] w-[18px]"
                ...
                <div className="flex md:flex-col flex-row md:gap-5 items-center justify-start w-full">
                  ...
                  <Img
                    className="h-[50px] md:ml-[0] ml-[298px] w-[50px]"
                    src="images/img_favorite_50x50.svg"
                    alt="favorite"
                  />
                  <Img
                    className="h-8 md:ml-[0] ml-[273px] w-8"
              ...
              <Button
                className="capitalize cursor-pointer font-medium min-w-[1036px] md:min-w-full mt-[46px] text-[17.59px] text-center"
                shape="round"
                color="light_blue_300"
                size="sm"
                variant="fill"
