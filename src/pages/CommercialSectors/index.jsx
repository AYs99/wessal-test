...
const CommercialSectorsPage = () => {
  const navigate = useNavigate();

  return (
    <>
      <div className="bg-blue_gray-800 flex flex-col font-dinnextltarabic items-center justify-start mx-auto w-full">
        <div className="md:h-[1190px] h-[823px] md:px-5 relative w-full">
          <Img
            className="h-[823px] m-auto object-cover w-full"
            src="images/img_pexelsfauxels3184394.png"
            alt="pexelsfauxelsThirtyOne"
          />
          <div className="absolute md:h-[1190px] h-[823px] inset-[0] justify-center m-auto w-full">
            <Img
              className="h-[823px] m-auto object-cover w-full"
              src="images/img_pexelslyhuot3939471_823x1440.png"
              alt="pexelslyhuot393"
            />
            <div className="absolute bg-gradient  flex flex-col h-full inset-[0] items-center justify-center m-auto p-[21px] sm:px-5 w-full">
              ...
              <Text
                className="capitalize mt-[233px] text-center text-lg text-light_blue-300 tracking-[2.64px]"
                size="txtDINNextLTArabicBold18"
              >
                Commercial
              </Text>
              <Text
                className="capitalize leading-[49.00px] mt-4 sm:text-4xl md:text-[38px] text-[40px] text-center text-yellow-700 tracking-[-0.36px]"
              ...
              <Text
                className="leading-[37.00px] lowercase mb-[260px] mt-[25px] text-center text-white-A700 text-xl tracking-[-0.36px] w-[52%] sm:w-full"
...
export default CommercialSectorsPage;
