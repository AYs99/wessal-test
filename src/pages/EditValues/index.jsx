    ...
    <>
      <div className="bg-blue_gray-800 flex flex-col font-dinnextltarabic items-center justify-start mx-auto w-full">
        <div className="flex md:flex-col flex-row md:gap-5 items-start justify-evenly w-full">
          <Sidebar11 className="!sticky !w-[254px] bg-blue_gray-800 flex h-screen md:hidden justify-start overflow-auto md:px-5 shadow-bs1 top-[0]" />
          <div className="flex flex-1 flex-col font-cairo gap-[42px] items-center justify-start md:px-5 w-full">
            ...
            <div className="flex flex-col font-dinnextltarabic gap-[21px] items-start justify-start w-[88%] md:w-full">
              ...
              <div className="flex md:flex-col flex-row gap-4 items-center justify-between ml-0.5 md:ml-[0] w-full">
...
to manage and control smart devices in your commercial and.`}
                ...
                <div className="flex md:flex-1 flex-col gap-[9px] items-start justify-start w-1/2 md:w-full">
                  ...
                  <div className="flex flex-col items-center justify-end outline-[0.5px] outline-dashed outline-white-A700 p-[18px] rounded-lg w-full">
                    <div className="flex flex-col gap-1.5 items-center justify-start mt-1.5 w-[26%] md:w-full">
                      <Img
                        className="h-12 w-12"
